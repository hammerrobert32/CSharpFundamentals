...
namespace _06_RepositoryPattern_Tests
{
    ...
    public class StreamingContentRepositoryTests
    {
        ...
        public void Arrange()
        {
            ...
            _content = new StreamingContent("Rubber", "a car tyre comes to life with the power to make people explode", "R", 5.8, false, GenreType.Drama);
        ...
        public void UpdateExistingContent_ShouldReturnTrue()
        {
            //Arrange
            //TestInitialize
            StreamingContent newContent = new StreamingContent("Rubber", "a car tyre comes to " +
                "life with the power to make people explode", "R", 10, false, GenreType.RomCom);
